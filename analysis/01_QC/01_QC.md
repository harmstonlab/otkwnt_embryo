...
![](../figures/01_QC/unnamed-chunk-29-1.png)
...
# Plot
ggplot(otk1_norm, aes(x = condition, y = counts, fill = condition)) +
  geom_boxplot() +
  geom_point(size = 0.5) +
  labs(title = "otk1", 
       x = "", y = "Normalized counts") +
  scale_fill_manual(values = manual_colors) +
  scale_y_continuous(expand = c(0, NA), limits = c(0, 8e4)) +
  theme_classic() +
...
# Plot
ggplot(otk2_norm, aes(x = condition, y = counts, fill = condition)) +
  geom_boxplot() +
  geom_point(size = 0.5) +
  labs(title = "otk2", 
       x = "", y = "Normalized counts") +
  scale_fill_manual(values = manual_colors) +
  scale_y_continuous(expand = c(0, NA), limits = c(0, 3000)) +
  theme_classic() +
  theme(axis.text.x = element_text(angle = 90), 
        legend.position = "none") 
```
...
# Plot
ggplot(wnt4_norm, aes(x = condition, y = counts, fill = condition)) +
  geom_boxplot() +
  geom_point(size = 0.5) +
  labs(title = "wnt4", 
       x = "", y = "Normalized counts") +
